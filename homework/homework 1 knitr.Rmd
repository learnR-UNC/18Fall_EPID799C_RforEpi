...
This is an R Markdown document - ideally for HW1, another edit just to test - more edits. Markdown is a simple formatting syntax for authoring HTML, PDF, and MS Word documents. For more details on using R Markdown see <http://rmarkdown.rstudio.com>.
