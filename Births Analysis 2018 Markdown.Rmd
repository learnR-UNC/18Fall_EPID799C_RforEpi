...
The purpose of this homework is to familiarize you with the `apply` family, which are powerful tools that build on vectorization (which converts to speed in R -- Section 1). In addition, we will start to play with dplyr and ggplot (Section 2).

## Overview of Homework 2, Part 1
