...
pt[2,1]-pt[1,1] #(HW4.1.1A)
pt[2,1]/pt[1,1] #(HW4.1.1B)
(pt[2,1]/pt[1,1])/(pt[2,2]/pt[1,2]) #(HW4.1.1C)
# For tabular effects, see epi2by2 and epitools packages... or not. It is very "particular"
...
# factor referrent matters! #HW4.2.Q5
...
# Model object structure HW4.2.Q6
str(m_crude_rd)
